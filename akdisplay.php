...
<body background="http://localhost/House/House/c.jpg">
 ...
 <td> <button class="btn-danger btn"> <a href="kdelete.php?id=<?php echo $res['id']; ?>" class="text-white"> Delete </a>  </button> <br><br>
  <button class="btn-primary btn"> <a href="kupdate.php?id=<?php echo $res['id']; ?>" class="text-white"> Update </a> </button> </td>
