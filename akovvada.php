<!DOCTYPE html>
<html>
<title>KOVVADA</title><link rel="icon" type="image/gif/png" href="http://localhost/House/House/15.jpg">
<style>
table, th, td {
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
         echo "<tr>";
				...
				echo "<td>";  ?> <a href="http://localhost/House/keditadmin.php"><button id="edit_<?php echo $image ?>"<font size="4" color="black" font="Lucida Handwriting"><b>Edit</b></font></button></a><?php "</td>";
				echo "<td>";  ?> <a href="http://localhost/House/kdeleteadmin.php"><button id="<?php echo $id ?>"<font size="4" color="black" font="Lucida Handwriting"><b>Delete</b></font></button></a><?php echo "</td>";
			echo "</tr>";
    }
    echo "</table>";
} else {
