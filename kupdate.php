<?php
 ...
 $q = " update kovvada set id=$id, image='$image', typeofhouse='$typeofhouse', rentpermonth='$rentpermonth', nameofprovider='$nameofprovider', dno='$dno', contact='$contact', address='$address' where id=$id  ";
